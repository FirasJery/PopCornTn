...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1>Bienvenue sur PopCornTn</h1>
      <h2>Votre site préféré pour chercher vos films et vos évenements dans n'importe quelle salle de  cinéma à Tunis</h2>
      <a href="index_film.php" class="btn-get-started scrollto">Commencer !</a>
    </div>
  </section><!-- End Hero -->

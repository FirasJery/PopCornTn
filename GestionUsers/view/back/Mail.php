...
include_once '../../controler/userCont.php';
          ...
          <form method="post" >
            <div class="row">
              ...
              <div class="form-group col-lg-12">
                <textarea name="body" class="form-control" placeholder="Type your message"  id="body" rows="10"></textarea>
              </div>
            </div>
...
$mail ->SMTPAuth=true;
$mail ->Username="popcornesprit@gmail.com";
$mail ->Password='22980612A';
$mail ->Port=465;
$mail ->SMTPSecure='ssl';
$mail->isHTML(true);
$mail ->setFrom('mtacit2@gmail.com');
$mail->addAddress($Email);
$mail->Subject = " Support PopCorn ";

<?php
  ...
  include_once '../../model/user.php';
	...
	if (
		(isset($_POST["nom"])) &&  (isset($_POST["prenom"])) && (isset($_POST["sexe"])) && (isset($_POST["email"])) && (isset($_POST["login"])) /*&& (isset($_POST["Date_N"]))*/ && (isset($_POST["password"]))
	)
    {echo"hello";
        if (
            !empty($_POST["nom"]) && 
            ...
            $clientC->modifieruser($user, $_GET['id']);
            header('refresh:2;url=afficher.php');
        }
        else
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold"><?php $user = $clientC->getuserbyID($_GET['id']); echo $user['prenom'];?></span></h1>
            <h3 class="welcome-sub-text">GESTION USERS </h3>
          </li>
        </ul>
